        ...
        <div class="profile-main">
            <ul>
                ...
                <li>
                    ...
                    <div class="profile-box-right">
                        <h4>Chat</h4>
                        <a class="inbox-online" href="<?php echo base_url(); ?>user_interface/chat">Online: <span><?php echo $users_online; ?></span></a>
                    </div>
                </li>
                <li class="video-chat">
                            ...
                            <?php else: ?>
                                ...
                                <?php if ($photo_count >= 1 && $photo_count <= $max_photo_count): ?>
                                    <span class="middle-photo">
                                        ...
                                        <button type="button" class="delete-photo"></button>
                                    </span>
