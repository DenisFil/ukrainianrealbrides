...
function collision($div1, $div2, number) {
...
$('#slider-weight').slider({
    ...
    slide: function (event, ui) {
        ...
        $.each(ui.values, function (index, value) {
            var lbs = value * 2.20462;
            lbs = lbs.toFixed(1);
            ui.values[index] = '<section><span style="display: block; ">' + value + '</span><span> (' + lbs + ' lbs)</span></section>';
        });
        ...
        $('.both-holder:eq(2) .price-range-both-2').html(ui.values[0] + ' - ' + ui.values[1]);
         ...
         $('.price-range-min-2, .price-range-max-2').css('opacity', '0');
         $('.price-range-both-2').css('display', 'block');
         } else {
         $('.price-range-min-2, .price-range-max-2').css('opacity', '1');
         $('.price-range-both-2').css('display', 'none');
         }
...
$(document).ready(function () {
    var selector = '#slider-weight';

    var minWeight = $(selector).slider('values', 0);
    var lbs = minWeight * 2.20462;
    lbs = lbs.toFixed(1);
    var startMinWeight = '<section><span style="display: block; ">' + minWeight + '</span><span> (' + lbs + 'lbs)</span></section>';

    $('.ui-slider-handle:eq(4)').append('<span class="price-range-min-2 value">' + startMinWeight + '</span>');

    var maxWeight = $(selector).slider('values', 1);
    lbs = maxWeight * 2.20462;
    lbs = lbs.toFixed(1);
...
$('#slider-height').slider({
    ...
    slide: function (event, ui) {
        ...
        $.each(ui.values, function (index, value) {
            ...
            var intermediate = inches / 12;
            intermediate = intermediate.toFixed(2);
            var ft_intermediate = Math.floor(intermediate);
            intermediate = intermediate - ft_intermediate;
            inches = intermediate * 12;
            inches = Math.round(inches);
            ui.values[index] = '<section><span style="display: block; ">' + value + '</span>' + '<span> (' + ft_intermediate + "' " + inches + "'')</span></section>";
        });
        ...
        if (collision($('.price-range-min-3'), $('.price-range-max-3'), 60) == true) {
            $('.price-range-min-3, .price-range-max-3').css('opacity', '0');
            $('.price-range-both-3').css('display', 'block');
        } else {
            $('.price-range-min-3, .price-range-max-3').css('opacity', '1');
            $('.price-range-both-3').css('display', 'none');
        }
    }
});
...
$(document).ready(function () {
    var selector = '#slider-height';
    var minHeight = $(selector).slider('values', 0);
    var inches = minHeight / 2.54;
    inches = inches.toFixed(2);
    var intermediate = inches / 12;
    intermediate = intermediate.toFixed(2);
    var ft_intermediate = Math.floor(intermediate);
    ...
    inches = intermediate * 12;
    inches = Math.round(inches);
    var startMinHeight = '<span style="display: block; ">' + minHeight + '</span>' + '<span> (' + ft_intermediate + "' " + inches + "'')</span>";
    $('.ui-slider-handle:eq(6)').append('<span class="price-range-min-3 value">' + startMinHeight + '</span>');
    var newMinHeight = '<span>' + minHeight + ' (' + ft_intermediate + "' " + inches + "'')</span>";

    var maxHeight = $(selector).slider('values', 1);
    inches = maxHeight / 2.54;
    inches = inches.toFixed(2);
    intermediate = inches / 12;
    intermediate = intermediate.toFixed(2);
    ft_intermediate = Math.floor(intermediate);
    intermediate = intermediate - ft_intermediate;
    inches = intermediate * 12;
    inches = Math.round(inches);
    var startMaxHeight = '<span style="display: block; ">' + maxHeight + '</span>' + '<span> (' + ft_intermediate + "' " + inches + "'')</span>";
