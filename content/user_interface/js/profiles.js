                            ...
                            if (firstData != null){
                                if (i < length) {
                                    if (data.login == 1) {
                                        ...
                                        html = '<div class="search-profile-block"><img src="' + baseUrl + 'content/profiles/avatars/' + firstData[i].id + '/' + firstData[i].avatar + '_avatar.jpg" alt="Profile photo" width="196" height="298" ><div class="search-profile-info"><strong>' + firstData[i].name + ', ' + '<span>' + firstData[i].birthday + '</span></strong><span>' + firstData[i].country_name + ', ' + firstData[i].city + '</span><em>Online</em><ul><li><a href=""><img src="' + baseUrl + 'content/user_interface/img/main/messaging.png" width="23" height="23" alt="Send letter" /><span>Send Letter</span></a></li><li class="search-chat-invite"><a href=""><img src="' + baseUrl + 'content/user_interface/img/main/chat.png" width="25" height="25" alt="Invite to chat" /><span>Invite to chat</span></a></li><li class="search-send-gift"><a href=""><img src="' + baseUrl + 'content/user_interface/img/main/gift-service.png" width="22" height="29" alt="Send gift" /><span>Send Gift</span></a></li></ul><a href="" class="view-profile-button">View Profile</a></div></div>';
                                    }
